    ...
    <html lang="en">
      <body>
        ...
        <Script id="gtranslate-settings" strategy="afterInteractive">
          {`window.gtranslateSettings = {"default_language":"en","native_language_names":true,"detect_browser_language":true,"languages":["en","fr","it","es","ru","de","sq"],"wrapper_selector":".gtranslate_wrapper","flag_size":16,"switcher_open_direction":"top","flag_style":"3d","alt_flags":{"en":"usa"}}`}
        </Script>
