      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <p style={{ lineHeight: 1.8, color: 'var(--text-secondary)', marginBottom: '1rem' }}>
            At Metrolean Market, we are committed to protecting your privacy and ensuring the security of your syndicate and personal data. This Privacy Policy outlines how we collect, use, and safeguard the information you provide when using our syndicate distribution services.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <p style={{ lineHeight: 1.8, color: 'var(--text-secondary)', marginBottom: '1rem' }}>
            We collect information necessary to process your syndicate orders, including:
          </p>
          <ul style={{ lineHeight: 1.8, color: 'var(--text-secondary)', paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <li>Syndicate preferences and order history.</li>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <ul style={{ lineHeight: 1.8, color: 'var(--text-secondary)', paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            <li>Finalizing distribution details via WhatsApp syndicate desk.</li>
        ...
        <section style={{ marginBottom: '3rem' }}>
          ...
          <p style={{ lineHeight: 1.8, color: 'var(--text-secondary)', marginBottom: '1rem' }}>
            We implement industry-standard security measures to protect your syndicate information. All data transmitted through our checkout process is encrypted using Secure Socket Layer (SSL) technology. Our internal systems follow strict data access protocols.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '3rem', borderTop: '1px solid var(--border)', paddingTop: '3rem' }}>
          ...
          <p style={{ lineHeight: 1.8, color: 'var(--text-secondary)', marginBottom: '1rem' }}>
            If you have any questions regarding this privacy policy, you may contact our syndicate desk at:
          </p>
