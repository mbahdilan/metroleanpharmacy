                      ...
                      <tr key={product.id} onClick={() => handleEditClick(product)}>
                        ...
                        <td style={{ textAlign: 'center' }}>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', alignItems: 'center' }}>
                            <span className={`status-chip ${product.is_active ? 'activated' : 'muted'}`}>
                              {product.is_active ? 'Visible' : 'Hidden'}
                            </span>
                            <span style={{ fontSize: '0.65rem', fontWeight: 700, color: product.units_in_stock > 0 ? '#0ca678' : '#fa5252' }}>
                              {product.units_in_stock > 0 ? 'IN STOCK' : 'OUT OF STOCK'}
                            </span>
                          </div>
                        </td>
          ...
          <div className="analytics-view">
            ...
            <div className="metrics-row">
              ...
              <div className="stat-card-krafts">
                ...
                <div className="value">{stats.outOfStock} <span className={`trend ${stats.outOfStock > 0 ? 'down' : 'up'}`}>{stats.outOfStock > 0 ? 'Warning' : 'Optimal'}</span></div>
              </div>
              <div className="stat-card-krafts">
